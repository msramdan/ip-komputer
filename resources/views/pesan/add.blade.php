...
@section('content')
    <div class="container-fluid">
        {{ Breadcrumbs::render('pesan-tambah') }}
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <div class="mb-3">
                                        ...
                                        nama" type="text" value="{{ old('nama') }}" placeholder="Nama" name="nama" autocomplete="off">
                                        @error('nama')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        judul" type="text" value="{{ old('judul') }}" placeholder="Judul" name="judul" autocomplete="off">
                                        @error('judul')
                                            <span style="color: red;">{{ $message }}</span>
                                        @enderror
                                    </div>
