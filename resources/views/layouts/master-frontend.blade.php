            ...
            <div class='row'>
                            ...
                            <ul class="nav">
                                @foreach ($kategori as $data)
                                    <li class="dropdown menu-item">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{ $data->nama_kategori }}</a>
                                    </li>
                                @endforeach
                ...
                <div class='col-md-9'>
                    <div id="category" class="category-carousel hidden-xs">
                        <div class="item">
                            <div class="image">
                                <img src=" {{ asset('temp-front-end/assets/images/banners/banner.jpg') }}" alt="" class="img-responsive">
                            </div>
